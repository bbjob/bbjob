                                ...
                                <#if alpha_index == 0>
                                    ...
                                    <#elseif alpha == "p">
                                        <div class="${confMap.className}pic_fl ${confMap.className}fl">
                                            <a href="${data.dataList[6]?default('javascript:void(0)')}" title="${data.dataList[0]?default('')}" target='_blank'><img src="${data.dataList[2]?default('../images/picNotFund.jpg')}" border=0 width='${confMap.picWide?default("")}' height='${confMap.picHeight?default("")}' title="${data.dataList[0]?default('')}"></a>
                                        </div>
                                    <#elseif alpha == "s">
