                        ...
                        <div class="modalTable">
                            <#list confMap.confAlphaList as alpha>
                                <#if alpha_index == 0>
                                    ...
                                    <#elseif alpha == "a">
                                        <div class="${confMap.className}content">作者：${data.dataList[3]?default('')}</div>
                                    <#elseif alpha == "l">
                                        <div class="${confMap.className}content">浏览量：${data.dataList[4]?default('')}</div>
                                    <#elseif alpha == "d">
                                        <div class="${confMap.className}content">时间：${data.dataList[5]?default('')}</div>
                                    <#else>
                                    </#if>
                                <#else>
                                    <#if alpha == "t">
