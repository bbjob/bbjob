                                    ...
                                    <#if alpha_index lt 2>
                                        ...
                                        <#elseif alpha == "p">
                                            <div class="${confMap.className}pic">
                                                <a href="${data.dataList[6]?default('javascript:void(0)')}" title='${data.dataList[0]}' target='_blank'><img src='${data.dataList[2]}' border=0 width='${confMap.picWide?default(409)}' height='${confMap.picHeight?default(237)}' title='${data.dataList[0]}'></a>
                                            </div>
                                            </td>
                                        <#elseif alpha == "s">
