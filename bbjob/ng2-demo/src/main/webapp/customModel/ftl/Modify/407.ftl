                            ...
                            <#if alpha_index lt 1>
                                ...
                                <#elseif alpha == "p">
                                    <div class="${confMap.className}pic">
                                        <a href="${data.dataList[6]?default('javascript:void(0)')}" title="${data.dataList[0]?default('')}" target='_blank'><img src="${data.dataList[2]?default('../images/picNotFund.jpg')}" border=0 width='${confMap.picWide?default(314)}' height='${confMap.picHeight?default(195)}' title="${data.dataList[0]?default('')}"></a>
                                    </div>
                                <#elseif alpha == "s">
                                    <div class="${confMap.className}content">${data.dataList[1]?default('')}</div>
                                <#elseif alpha == "a">
                                    <div class="${confMap.className}author">作者：${data.dataList[3]?default('')}</div>
                                <#elseif alpha == "l">
                                    <div class="${confMap.className}pv">浏览量：${data.dataList[4]?default('')}</div>
                                <#elseif alpha == "d">
                                    <div class="${confMap.className}date">时间：${data.dataList[5]?default('')}</div>
                                <#else>
                                </#if>
                            <#else>
                                <#if alpha == "t">
                                    <div class="${confMap.className}title_fl fl">
                                        <#if confMap.prefixType??>
                                            <#if confMap.prefixType == 0>
                                                ${confMap.prefixContent}
                                            <#else>
                                ...
                                <#elseif alpha == "p">
                                    <div class="${confMap.className}pic_fl fl">
                                        <a href="${data.dataList[6]?default('javascript:void(0)')}" title="${data.dataList[0]?default('')}" target='_blank'><img src="${data.dataList[2]?default('../images/picNotFund.jpg')}" border=0 width='${confMap.picWide?default(314)}' height='${confMap.picHeight?default(195)}' title="${data.dataList[0]?default('')}"></a>
                                    </div>
                                <#elseif alpha == "s">
                                    <div class="${confMap.className}content_fl fl">${data.dataList[1]?default('')}</div>
                                <#elseif alpha == "a">
                                    <div class="${confMap.className}author_fl fl">作者：${data.dataList[3]?default('')}</div>
                                <#elseif alpha == "l">
                                    <div class="${confMap.className}pv_fl fl">浏览量：${data.dataList[4]?default('')}</div>
                                <#elseif alpha == "d">
                                    <div class="${confMap.className}date_fl fl">时间：${data.dataList[5]?default('')}</div>
                                <#else>
                                </#if>
                            </#if>
                ...
                <td>
                    <div class="modalTable">
                        <#list confMap.confAlphaList as alpha>
                            <#if alpha_index lt 1>
                                <#if alpha_index == 2>
                                    <div class="${confMap.className}fl ${confMap.className}div_all">
                                </#if>
                                <#if alpha == "t">
                                    <div class="${confMap.className}title">
                                        <#if confMap.prefixType??>
